...
/**
 * Adapter interface for storing and retrieving window geometry information.
 * 
 * @author matt
 *
 */
public interface WindowGeometryStorePersistence {
    /**
     * Store the Window Geometry
     * @param windowName a window name
     * @param geometry a String of the form x,y,width,height.
     */
    void setWindowGeometry(String windowName, String geometry);
